...
<div>
    <div class="flex max-md:flex-col items-start">
        <div class="w-full md:w-[220px] pb-4 mr-10">
            <flux:navlist>
                <flux:navlist.item badge="24" current>全部紀錄</flux:navlist.item>
                <flux:navlist.item badge="3" badgeColor="blue">獲得紀錄</flux:navlist.item>
                <flux:navlist.item badge="2" badgeColor="orange">使用紀錄</flux:navlist.item>
            </flux:navlist>
        </div>
        ...
        <div class="flex-1 max-md:pt-6 self-stretch">
            <div class="mx-auto [:where(&)]:max-w-7xl max-w-xl lg:max-w-3xl">
                <div class="flex justify-between">
                    <flux:heading size="xl" level="1">{{ __('Shopping Credit') }}</flux:heading>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-6">
                    <flux:card class="bg-zinc-50 border-0">
                        <flux:subheading>購物金總額</flux:subheading>
                        <flux:heading size="xl" class="mb-1">NT$ 7,532</flux:heading>
                    ...
                    <flux:card class="bg-zinc-50 border-0">
                        <flux:subheading>累計獲得總額</flux:subheading>
                        <flux:heading size="xl" class="mb-1">NT$ 7,532</flux:heading>
                        <div class="flex items-center gap-2">
                            <flux:icon.arrow-trending-up variant="micro" class="text-green-600 dark:text-green-500" />
                            <span class="text-sm text-green-600 dark:text-green-500">15.2%</span>
                    ...
                    <flux:card class="bg-zinc-50 border-0">
                        <flux:subheading>累計使用總額</flux:subheading>
                        <flux:heading size="xl" class="mb-1">NT$ 7,532</flux:heading>
                        <div class="flex items-center gap-2">
                            <flux:icon.arrow-trending-down variant="micro" class="text-red-600 dark:text-red-500" />
                            <span class="text-sm text-red-600 dark:text-red-500">15.2%</span>
                        </div>
                    </flux:card>
                </div>
...
<flux:button variant="subtle" size="sm" class="!text-blue-400 !hover:text-blue-700" wire:navigate href="{{route('member.order-detail', ['id' => '1130111ILUL'])}}">1130111ILUL</flux:button>
                            ...
                            <td class="py-3 px-3 first:pl-0 last:pr-0 text-sm  font-medium text-orange-800 dark:text-white" data-flux-cell="">
    - NT$ 3,130
</td>
...
<flux:button variant="subtle" size="sm" class="!text-blue-400 !hover:text-blue-700" wire:navigate href="{{route('member.order-detail', ['id' => '1121208HFY8'])}}">1121208HFY8</flux:button>
    ...
    2023/12/08
                            ...
                            <td class="py-3 px-3 first:pl-0 last:pr-0 text-sm  font-medium text-blue-800 dark:text-white" data-flux-cell="">
    + NT$ 3,120
</td>
                            <td class="py-3 px-3 first:pl-0 last:pr-0 text-sm  text-zinc-500 dark:text-zinc-300" data-flux-cell="">
    <ui-dropdown position="bottom end" offset="-25" data-flux-dropdown="">
